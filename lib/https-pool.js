...
class HttpsPool {
   ...
   */
  constructor(option) {
    const { timeout, max_servers, ...CAOption } = option;
    this._cache = {};
    /*
    * TODO: use lock in the future, We use Object.keys() now for multi process. (o(n) complexity)
    */
    // this._serverCount = 0;
    this.TIMEOUT = timeout || 6000;
    this.MAX_SERVERS = max_servers || 220;
    this._rawCA = createCACert(CAOption);
    this.CA = {
